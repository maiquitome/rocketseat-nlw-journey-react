...
export function App() {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-squares bg-no-repeat bg-center">
          ...
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-sm text-zinc-400">
                ...
                <b className="text-zinc-100">Florianópolis, Brasil</b> nas datas
                de <b className="text-zinc-100">16 a 27 de Agosto de 2024</b>{" "}
